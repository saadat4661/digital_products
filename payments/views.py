...
class PaymentView(APIView):
    ...
    def post(self, request):
        ...
        if st != 10:
            ...
            payment.save()
            return Response({'detail':'Payment was canceled by user'}, status=status.HTTP_400_BAD_REQUEST)
        ...
        return Response({'detail':'Payment was successfully done.'}, status=status.HTTP_200_OK)