# Generated by Django 3.2 on 2023-03-12 08:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Required, 30 characters or fewer, starting with letter, letters, digial number', max_length=32, unique=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z][a-zA-Z0-9_\\.]+$', 'Enter a valid username starting with a-z.This value may contain only letters, numbers and underscore characters', 'invalid')], verbose_name='username')),
                ('first_name', models.CharField(blank=True, max_length=30, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=30, verbose_name='last name')),
                ('email', models.CharField(blank=True, max_length=70, null=True, unique=True, verbose_name='email address')),
                ('phone_number', models.BigIntegerField(blank=True, null=True, unique=True, validators=[django.core.validators.RegexValidator('^989[0-3,0]\\d{8}$', 'Enter a valid mobile number', 'invalid')], verbose_name='mobile number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.BooleanField(help_text='female is False, male is True', verbose_name='gender')),
